...
export const OrbGenesis: React.FC = () => {
    ...
    for (const bf of BIRTH_FRAMES) {
        const p = interpolate(frame, [bf, bf + 1, bf + 12], [0, 1, 0], {
